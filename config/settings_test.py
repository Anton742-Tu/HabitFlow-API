...
HABIT_VALIDATION = {
    ...
    "USEFUL_HABIT_RULES": {
        "requires_reward_or_related": "Полезные привычки должны иметь либо вознаграждение, либо связанную привычку",
        "not_both": "Полезные привычки не могут иметь и вознаграждение, и связанную привычку одновременно",
    },
}
