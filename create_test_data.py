...
habits_data = [
    {'user': 'alex', 'action': 'Утренняя зарядка', 'place': 'Дом', 'time': '07:00', 'duration': 60,
     'frequency': 'daily', 'is_public': True, 'is_pleasant': False},
    {'user': 'alex', 'action': 'Чтение книги', 'place': 'Диван', 'time': '21:00', 'duration': 30, 'frequency': 'daily',
     'is_public': False, 'is_pleasant': False},
    {'user': 'maria', 'action': 'Пробежка в парке', 'place': 'Парк', 'time': '08:00', 'duration': 120,
     'frequency': 'weekly', 'is_public': True, 'is_pleasant': False},
    {'user': 'maria', 'action': 'Медитация', 'place': 'Комната', 'time': '07:30', 'duration': 15, 'frequency': 'daily',
     'is_public': True, 'is_pleasant': True},
    {'user': 'demo', 'action': 'Изучение английского', 'place': 'Кафе', 'time': '18:00', 'duration': 45,
     'frequency': 'daily', 'is_public': True, 'is_pleasant': False},
    {'user': 'demo', 'action': 'Планирование дня', 'place': 'Офис', 'time': '09:00', 'duration': 10,
     'frequency': 'daily', 'is_public': False, 'is_pleasant': False},
]
